...
def step_child_once (child,mev):                       #line 285
    before_state =  child.state                        #line 286
    child.handler ( child, mev)                        #line 287
    after_state =  child.state                         #line 288
    return [ before_state ==  "idle" and  after_state!= "idle", before_state!= "idle" and  after_state!= "idle", before_state!= "idle" and  after_state ==  "idle"]#line 291#line 292#line 293

def step_children (container,causingMevent):           #line 294
    container.state =  "idle"                          #line 295#line 296
    # phase 1 - loop through children and process inputs or children that not "idle" #line 297
    for child in  list ( container.visit_ordering):    #line 298
        # child = container represents self, skip it   #line 299
        if (not (is_self ( child, container))):        #line 300
            if (not ((0==len( child.inq)))):           #line 301
                mev =  child.inq.popleft ()            #line 302
                step_child_once ( child, mev)          #line 303#line 304
                destroy_mevent ( mev)                  #line 305
            else:                                      #line 306
                if  child.state!= "idle":              #line 307
                    mev = force_tick ( container, child)#line 308
                    step_child_once ( child, mev)      #line 309
                    destroy_mevent ( mev)              #line 310#line 311#line 312#line 313#line 314

    container.visit_ordering = deque ([])              #line 315#line 316
    # phase 2 - loop through children and route their outputs to appropriate receiver queues based on .connections #line 317
    for child in  container.children:                  #line 318
        if  child.state ==  "active":                  #line 319
            # if child remains active, then the container must remain active and must propagate “ticks“ to child#line 320
            container.state =  "active"                #line 321#line 322#line 323
        while (not ((0==len( child.outq)))):           #line 324
            mev =  child.outq.popleft ()               #line 325
            route ( container, child, mev)             #line 326
            destroy_mevent ( mev)                      #line 327#line 328#line 329#line 330#line 331
