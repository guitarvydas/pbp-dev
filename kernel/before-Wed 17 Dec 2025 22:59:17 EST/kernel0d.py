...
def deposit (parent,conn,mevent):                      #line 263
    print ( str( " deposit from [") +  str( conn.sender.name) +  str( "] to [") +  str( conn.receiver.name) +  "]"    , file=sys.stderr)#line 264
    new_mevent = make_mevent ( conn.receiver.port, mevent.datum)#line 265
    push_mevent ( parent, conn.receiver.component, conn.receiver.queue, new_mevent)#line 266#line 267#line 268

def force_tick (parent,eh):                            #line 269
    tick_mev = make_mevent ( ".",new_datum_bang ())    #line 270
    push_mevent ( parent, eh, eh.inq, tick_mev)        #line 271
    return  tick_mev                                   #line 272#line 273#line 274

def push_mevent (parent,receiver,inq,m):               #line 275
    inq.append ( m)                                    #line 276
    parent.visit_ordering.append ( receiver)           #line 277#line 278#line 279

def is_self (child,container):                         #line 280
    # in an earlier version “self“ was denoted as ϕ    #line 281
    return  child ==  container                        #line 282#line 283#line 284

def step_child_once (child,mev):                       #line 285
    print ( str( "   step_child_once ") +  child.name , file=sys.stderr)#line 286
    before_state =  child.state                        #line 287
    child.handler ( child, mev)                        #line 288
    after_state =  child.state                         #line 289
    return [ before_state ==  "idle" and  after_state!= "idle", before_state!= "idle" and  after_state!= "idle", before_state!= "idle" and  after_state ==  "idle"]#line 292#line 293#line 294

def step_children (container,causingMevent):           #line 295
    print ( str( ".. step_children of ") +  container.name , file=sys.stderr)#line 296
    container.state =  "idle"                          #line 297#line 298
    # phase 1 - loop through children and process inputs or children that not "idle" #line 299
    for child in  list ( container.visit_ordering):    #line 300
        # child = container represents self, skip it   #line 301
        if (not (is_self ( child, container))):        #line 302
            if (not ((0==len( child.inq)))):           #line 303
                mev =  child.inq.popleft ()            #line 304
                step_child_once ( child, mev)          #line 305#line 306
                destroy_mevent ( mev)                  #line 307
            else:                                      #line 308
                if  child.state!= "idle":              #line 309
                    mev = force_tick ( container, child)#line 310
                    step_child_once ( child, mev)      #line 311
                    destroy_mevent ( mev)              #line 312#line 313#line 314#line 315#line 316

    container.visit_ordering = deque ([])              #line 317#line 318
    # phase 2 - loop through children and route their outputs to appropriate receiver queues based on .connections #line 319
    for child in  container.children:                  #line 320
        if  child.state ==  "active":                  #line 321
            # if child remains active, then the container must remain active and must propagate “ticks“ to child#line 322
            container.state =  "active"                #line 323#line 324#line 325
        while (not ((0==len( child.outq)))):           #line 326
            mev =  child.outq.popleft ()               #line 327
            route ( container, child, mev)             #line 328
            destroy_mevent ( mev)                      #line 329#line 330#line 331#line 332#line 333
